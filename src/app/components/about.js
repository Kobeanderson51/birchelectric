        ...
        <div className="bg-gradient-to-b from-gray-100 to-white py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
            <div className="max-w-7xl mx-auto">
                ...
                <div 
                    ...
                    className={`flex flex-col md:flex-row items-center md:items-start justify-center md:justify-between mb-12 sm:mb-16 md:mb-20 transform transition-all duration-1000 ${
                        isVisible.credentials ? 'translate-x-0 opacity-100' : 'translate-x-0 sm:-translate-x-full opacity-50 sm:opacity-0'
                    }`}
                >
                    <div className="md:w-1/2 mb-6 md:mb-0 px-2 sm:px-4">
                        <div className="relative group w-full max-w-md mx-auto md:max-w-none">
                            <Image 
                                ...
                                width={600} 
                                height={400} 
                                className="rounded-xl shadow-2xl w-full h-auto transition-transform duration-500 group-hover:scale-[1.02]"
                            />
                    ...
                    <div className="md:w-1/2 text-gray-800 px-4 sm:px-6 md:px-8 text-center md:text-left">
                        <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 sm:mb-6 text-blue-600">Our Credentials</h3>
                ...
                <div 
                    ...
                    className={`flex flex-col md:flex-row-reverse items-center md:items-start justify-center md:justify-between mb-12 sm:mb-16 md:mb-20 transform transition-all duration-1000 ${
                        isVisible.services ? 'translate-x-0 opacity-100' : 'translate-x-0 sm:translate-x-full opacity-50 sm:opacity-0'
                    }`}
                >
                    <div className="md:w-1/2 mb-6 md:mb-0 px-2 sm:px-4">
                        <div className="relative group w-full max-w-md mx-auto md:max-w-none">
                    ...
                    <div className="md:w-1/2 text-gray-800 px-4 sm:px-6 md:px-8 text-center md:text-left">
                        <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 sm:mb-6 text-blue-600">Our Services</h3>
                        <p className="text-base sm:text-lg md:text-xl leading-relaxed mb-4 sm:mb-6 text-gray-600">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                            <div className="p-3 sm:p-4 bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
                                <h4 className="text-base sm:text-xl font-bold text-blue-600 text-center">Commercial Electrical</h4>
                            </div>
                            <div className="p-3 sm:p-4 bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
                                <h4 className="text-base sm:text-xl font-bold text-blue-600 text-center">Residential Electrical</h4>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div 
                    ...
                    className={`flex flex-col md:flex-row items-center md:items-start justify-center md:justify-between transform transition-all duration-1000 ${
                        isVisible.approach ? 'translate-x-0 opacity-100' : 'translate-x-0 sm:-translate-x-full opacity-50 sm:opacity-0'
                    }`}
                >
                    <div className="md:w-1/2 mb-6 md:mb-0 px-2 sm:px-4">
                        <div className="relative group w-full max-w-md mx-auto md:max-w-none">
                    ...
                    <div className="md:w-1/2 text-gray-800 px-4 sm:px-6 md:px-8 text-center md:text-left">
                        <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 sm:mb-6 text-blue-600">Our Approach</h3>
                        <p className="text-base sm:text-lg md:text-xl leading-relaxed mb-4 sm:mb-6 text-gray-600">
